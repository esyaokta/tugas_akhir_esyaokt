<x-admin.app>
  <x-slot name="header">
    <h2 class="font-semibold text-3xl text-gray-800  flex items-center justify-center mb-0">
      {{ __('Barang') }}
    </h2>
  </x-slot>
  ...
  <div class="flex flex-col justify-center gap-2">
    ...
    <form class="flex" action="{{route('admin.barang.search')}}" method="POST">
      @csrf
          ...
          @foreach ($barang as $b)
            <tr class="bg-[#FFFCFC] dark:bg-gray-800 dark:border-gray-700 border-b border-black">
              ...
              <td class="px-6 py-4 flex justify-center gap-3">
                ...
                <form action="{{ route('admin.barang.destroy', ['id' => $b->id]) }}" method="post" id="delete{{$b->id}}">
                ...
                <script>
    document.querySelector('#delete{{$b->id}}').onsubmit = function(e){
      var form =this;
    e.preventDefault();
